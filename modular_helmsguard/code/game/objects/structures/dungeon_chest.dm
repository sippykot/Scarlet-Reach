...
/obj/effect/spawner/lootdrop/roguetown/dungeon_chest
	...
	/obj/structure/closet/crate/chest/dungeon/potions = 3,
...
/obj/effect/spawner/dungeons/maybechest/Initialize(mapload)
	...
	tospawn = pick(
	/obj/effect/spawner/lootdrop/roguetown/dungeon_chest,
	/obj/effect/spawner/lootdrop/roguetown/corpse_spawner/dungeon,
	)
	if(prob(50))
...
/obj/structure/closet/crate/chest/dungeon/armor/PopulateContents()
	...
	var/list/loot = list(//armor
		...
		/obj/item/clothing/suit/roguetown/armor/gambeson/light = 60,
		/obj/item/clothing/suit/roguetown/armor/gambeson/heavy = 30,
		...
		/obj/item/clothing/suit/roguetown/armor/brigandine/light = 43,
		...
		/obj/item/clothing/suit/roguetown/armor/plate/scale = 30,
		/obj/item/clothing/suit/roguetown/armor/armordress = 30,
		/obj/item/clothing/suit/roguetown/armor/armordress/alt = 30,
		/obj/item/clothing/suit/roguetown/armor/leather = 50,
		...
		/obj/item/clothing/head/roguetown/helmet/kettle/wide = 15,
		/obj/item/clothing/head/roguetown/helmet/sallet = 15,
		/obj/item/clothing/head/roguetown/helmet/otavan = 15,
		/obj/item/clothing/head/roguetown/helmet/sallet/visored = 13,
		...
		/obj/item/clothing/neck/roguetown/bevor = 10,
		//feet
		/obj/item/clothing/shoes/roguetown/boots/armor/iron = 55,
...
/obj/structure/closet/crate/chest/dungeon/weapon/PopulateContents()
	...
	var/list/loot = list(//sword
		...
		/obj/item/rogueweapon/sword/gladius = 30,
		/obj/item/rogueweapon/sword/silver = 30,
		/obj/item/rogueweapon/sword/sabre/shamshir = 10,
	...
	//polearms
		...
		/obj/item/rogueweapon/spear/bronze = 20,
...
/obj/structure/closet/crate/chest/dungeon/materials/PopulateContents()
	...
	var/list/loot = list(//ingot
		...
		/obj/item/natural/fur = 50,		/obj/item/grown/log/tree/small = 40
		)
	var/I = pickweight(loot)
	var/O = pickweight(loot)
	var/E = pickweight(loot)
...
/obj/structure/closet/crate/chest/dungeon/potions


/obj/structure/closet/crate/chest/dungeon/potions/PopulateContents()
	..()
	var/list/loot = list(
		/obj/item/reagent_containers/glass/bottle/rogue/manapot = 15,
		/obj/item/reagent_containers/glass/bottle/rogue/poison = 10,
		/obj/item/reagent_containers/glass/bottle/rogue/wine = 10,

		//buff
		/obj/item/reagent_containers/glass/alchemical/strpot = 20,
		/obj/item/reagent_containers/glass/alchemical/perpot = 20,
		/obj/item/reagent_containers/glass/alchemical/endpot = 20,
		/obj/item/reagent_containers/glass/alchemical/conpot = 20,
		/obj/item/reagent_containers/glass/alchemical/intpot = 20,
		/obj/item/reagent_containers/glass/alchemical/spdpot = 20,
		/obj/item/reagent_containers/glass/alchemical/lucpot = 20,
...
/obj/structure/closet/crate/chest/reward/PopulateContents()
	...
	var/list/loot = list(
		...
		// /obj/item/rogueweapon/sword/long/vlord = 10,		/obj/item/rogueweapon/sword/long/marlin = 10,
